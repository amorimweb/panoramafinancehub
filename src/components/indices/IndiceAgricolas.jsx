  ...
  useEffect(() => {
    const loadWidget = () => {
      ...
      try {
        ...
        script.onload = () => {
          console.log('IndiceAgricolas widget carregado com sucesso');
          scriptLoaded.current = true;
        };
        
        script.onerror = (error) => {
          console.warn('Erro ao carregar widget de commodities agrícolas:', error);
        };
      ...
      >
        <div className="d-flex align-items-center justify-content-center h-100">
          <div className="text-center">
            ...
            <p className="text-muted small">Carregando Commodities Agrícolas...</p>
          </div>
        </div>
      </div>
    </ContainerIndices>
...
export default memo(IndiceAgricolas); 